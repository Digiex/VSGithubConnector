...
namespace VSGithubConnectorPkg_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        public void ValidateToolWindowShown()
        {
            ...
            MethodInfo method = typeof(VSGithubConnectorPkgPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
