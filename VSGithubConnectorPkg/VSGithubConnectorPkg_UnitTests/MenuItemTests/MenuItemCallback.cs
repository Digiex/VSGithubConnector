...
using Digiexnet.VSGithubConnectorPkg;

namespace VSGithubConnectorPkg_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSGithubConnectorPkgPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Digiexnet.VSGithubConnectorPkg.GuidList.guidVSGithubConnectorPkgCmdSet, (int)Digiexnet.VSGithubConnectorPkg.PkgCmdIDList.githubIssuesCmd);
